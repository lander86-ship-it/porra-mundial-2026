...
const groupMatches = [
  // GROUP A – Round 1
  ['A1','groups','A',1,'México','Sudáfrica','2026-06-11','15:00'],
  ['A1','groups','A',1,'Corea del Sur','República Checa','2026-06-11','22:00'],
  // GROUP B – Round 1
  ['B1','groups','B',1,'Canadá','Bosnia y Herzegovina','2026-06-12','17:00'],
  ['B1','groups','B',1,'Catar','Suiza','2026-06-13','14:00'],
  // GROUP C – Round 1
  ['C1','groups','C',1,'Brasil','Marruecos','2026-06-13','20:00'],
  ['C1','groups','C',1,'Haití','Escocia','2026-06-13','23:00'],
  // GROUP D – Round 1
  ['D1','groups','D',1,'Estados Unidos','Paraguay','2026-06-12','20:00'],
  ['D1','groups','D',1,'Australia','Turquía','2026-06-13','23:00'],
  // GROUP E – Round 1
  ['E1','groups','E',1,'Alemania','Curazao','2026-06-14','14:00'],
  ['E1','groups','E',1,'Costa de Marfil','Ecuador','2026-06-14','21:00'],
  // GROUP F – Round 1
  ['F1','groups','F',1,'Países Bajos','Japón','2026-06-14','17:00'],
  ['F1','groups','F',1,'Suecia','Túnez','2026-06-14','22:00'],
  // GROUP G – Round 1
  ['G1','groups','G',1,'Bélgica','Egipto','2026-06-15','14:00'],
  ['G1','groups','G',1,'Irán','Nueva Zelanda','2026-06-15','20:00'],
  // GROUP H – Round 1
  ['H1','groups','H',1,'España','Cabo Verde','2026-06-15','14:00'],
  ['H1','groups','H',1,'Arabia Saudita','Uruguay','2026-06-15','20:00'],
  // GROUP I – Round 1
  ['I1','groups','I',1,'Francia','Senegal','2026-06-16','17:00'],
  ['I1','groups','I',1,'Irak','Noruega','2026-06-16','20:00'],
  // GROUP J – Round 1
  ['J1','groups','J',1,'Argentina','Argelia','2026-06-16','22:00'],
  ['J1','groups','J',1,'Austria','Jordania','2026-06-16','23:00'],
  // GROUP K – Round 1
  ['K1','groups','K',1,'Portugal','RD Congo','2026-06-17','14:00'],
  ['K1','groups','K',1,'Uzbekistán','Colombia','2026-06-17','22:00'],
  // GROUP L – Round 1
  ['L1','groups','L',1,'Inglaterra','Croacia','2026-06-17','17:00'],
  ['L1','groups','L',1,'Ghana','Panamá','2026-06-17','21:00'],
  // GROUP A – Round 2
  ['A2','groups','A',2,'República Checa','Sudáfrica','2026-06-18','14:00'],
  ['A2','groups','A',2,'México','Corea del Sur','2026-06-18','21:00'],
  // GROUP B – Round 2
  ['B2','groups','B',2,'Suiza','Bosnia y Herzegovina','2026-06-18','14:00'],
  ['B2','groups','B',2,'Canadá','Catar','2026-06-18','17:00'],
  // GROUP C – Round 2
  ['C2','groups','C',2,'Escocia','Marruecos','2026-06-19','20:00'],
  ['C2','groups','C',2,'Brasil','Haití','2026-06-19','23:00'],
  // GROUP D – Round 2
  ['D2','groups','D',2,'Estados Unidos','Australia','2026-06-19','14:00'],
  ['D2','groups','D',2,'Turquía','Paraguay','2026-06-19','23:00'],
  // GROUP E – Round 2
  ['E2','groups','E',2,'Alemania','Costa de Marfil','2026-06-20','18:00'],
  ['E2','groups','E',2,'Ecuador','Curazao','2026-06-20','21:00'],
  // GROUP F – Round 2
  ['F2','groups','F',2,'Países Bajos','Suecia','2026-06-20','14:00'],
  ['F2','groups','F',2,'Túnez','Japón','2026-06-21','00:00'],
  // GROUP G – Round 2
  ['G2','groups','G',2,'Bélgica','Irán','2026-06-21','14:00'],
  ['G2','groups','G',2,'Nueva Zelanda','Egipto','2026-06-21','20:00'],
  // GROUP H – Round 2
  ['H2','groups','H',2,'España','Arabia Saudita','2026-06-21','14:00'],
  ['H2','groups','H',2,'Uruguay','Cabo Verde','2026-06-21','20:00'],
  // GROUP I – Round 2
  ['I2','groups','I',2,'Francia','Irak','2026-06-22','19:00'],
  ['I2','groups','I',2,'Noruega','Senegal','2026-06-22','22:00'],
  // GROUP J – Round 2
  ['J2','groups','J',2,'Argentina','Austria','2026-06-22','14:00'],
  ['J2','groups','J',2,'Jordania','Argelia','2026-06-22','22:00'],
  // GROUP K – Round 2
  ['K2','groups','K',2,'Portugal','Uzbekistán','2026-06-23','14:00'],
  ['K2','groups','K',2,'Colombia','RD Congo','2026-06-23','22:00'],
  // GROUP L – Round 2
  ['L2','groups','L',2,'Inglaterra','Ghana','2026-06-23','18:00'],
  ['L2','groups','L',2,'Panamá','Croacia','2026-06-23','21:00'],
  ...
  ['B3','groups','B',3,'Suiza','Canadá','2026-06-24','14:00'],
  ['B3','groups','B',3,'Bosnia y Herzegovina','Catar','2026-06-24','14:00'],
  // GROUP C – Round 3 (simultaneous)
  ['C3','groups','C',3,'Escocia','Brasil','2026-06-24','20:00'],
  ['C3','groups','C',3,'Marruecos','Haití','2026-06-24','20:00'],
  // GROUP D – Round 3 (simultaneous)
  ['D3','groups','D',3,'Turquía','Estados Unidos','2026-06-25','21:00'],
  ['D3','groups','D',3,'Paraguay','Australia','2026-06-25','21:00'],
  // GROUP E – Round 3 (simultaneous)
  ['E3','groups','E',3,'Curazao','Costa de Marfil','2026-06-25','18:00'],
  ['E3','groups','E',3,'Ecuador','Alemania','2026-06-25','18:00'],
  // GROUP F – Round 3 (simultaneous)
  ['F3','groups','F',3,'Japón','Suecia','2026-06-25','20:00'],
  ['F3','groups','F',3,'Túnez','Países Bajos','2026-06-25','20:00'],
  // GROUP G – Round 3 (simultaneous)
  ['G3','groups','G',3,'Egipto','Irán','2026-06-26','22:00'],
  ['G3','groups','G',3,'Nueva Zelanda','Bélgica','2026-06-26','22:00'],
  // GROUP H – Round 3 (simultaneous)
  ['H3','groups','H',3,'Cabo Verde','Arabia Saudita','2026-06-26','20:00'],
  ['H3','groups','H',3,'Uruguay','España','2026-06-26','20:00'],
  // GROUP I – Round 3 (simultaneous)
  ['I3','groups','I',3,'Noruega','Francia','2026-06-26','17:00'],
  ['I3','groups','I',3,'Senegal','Irak','2026-06-26','17:00'],
  // GROUP J – Round 3 (simultaneous)
  ['J3','groups','J',3,'Argelia','Austria','2026-06-27','23:00'],
  ['J3','groups','J',3,'Jordania','Argentina','2026-06-27','23:00'],
  // GROUP K – Round 3 (simultaneous)
  ['K3','groups','K',3,'Colombia','Portugal','2026-06-27','21:30'],
  ['K3','groups','K',3,'RD Congo','Uzbekistán','2026-06-27','21:30'],
  // GROUP L – Round 3 (simultaneous)
  ['L3','groups','L',3,'Panamá','Inglaterra','2026-06-27','19:00'],
  ['L3','groups','L',3,'Croacia','Ghana','2026-06-27','19:00'],
];
